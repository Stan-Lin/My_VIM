...
"past toggle
set pastetoggle=<F5>
map <Leader><F5> : set mouse=a
"vmap <S-F5> :!xclip -i -sel clip<CR>
vmap <F6> :!xclip -i -sel clip<CR>
map yp :-1r !xclip -o -sel clip<CR>
map <Leader><F7> :r!xclip -o<CR>

set clipboard=unnamed

"Quicikily build ctags
"map  :! ctags -R --c++-kinds=+p --fields=+iaS --extra=+q -f "%:p:h\\tags" "%:p:h"
map <Leader><F12> :! ctags -R --c++-kinds=+p --fields=+iaS --extra=+q 
